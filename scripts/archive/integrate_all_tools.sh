...
echo "í´— Integrating ALL remaining tools from directory..."

# =========================================================
# UPDATE TOOL REGISTRY (The Master List)
# =========================================================
echo "í·„ï¸  Registering 50+ Tools..."
...
import { 
  ...
  FileJson, Clock, Quote, Fingerprint, 
...
export const ALL_TOOLS = [
  ...
  // Legacy/Simple versions mapped if needed, otherwise hidden to keep UI clean
...
echo "âœ… All 50+ Tools have been registered and categorized!"
echo "Run 'npm run dev' to see your full suite."
