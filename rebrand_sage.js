...
console.log("🚑 REPAIRING LAYOUT & SEO DATA...");
...
// 1. REPAIR LAYOUT (Fixes the <EOF> error)
...
// 2. REPAIR DATABASE (Ensures 500+ keywords are saved)
const toolsDataCode = `import React from "react";
import { 
...
writeFile('app/layout.tsx', layoutCode);
writeFile('app/lib/tools-data.tsx', toolsDataCode);

console.log("✅ FIXED: Layout & SEO Database restored.");