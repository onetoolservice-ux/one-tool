...
echo "í´ Activating Wave 4: Crypto, Code & Design..."

# =========================================================
# 1. INSTALL DEPENDENCIES
# =========================================================
echo "í³¦ Installing crypto & formatting libs..."
if [ -f "yarn.lock" ]; then
...
# =========================================================
echo "í»¡ï¸ Activating Smart Hash..."
...
# =========================================================
echo "í²¾ Activating SQL Formatter..."
...
# =========================================================
echo "í¾¨ Activating Contrast Checker..."
...
# =========================================================
echo "í¶¼ï¸ Activating PNG Converter..."
