...
// so signup/password-reset emails are disabled and everyone logs in as this
// one admin user instead.
...
function LoginForm() {
  ...
  // Lets a "Sign in" link from e.g. Business OS bring the user back to where
  // they started (?redirect=/my-business/biz-dashboard) instead of the home
  // page — only ever an internal path, never an external URL.
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm">
              Sign in to access your tools and business data — everything you've saved stays backed up here.
            </p>
          </div>
