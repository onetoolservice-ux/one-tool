      ...
      <div className="border border-rose-100 rounded-2xl overflow-hidden">
        ...
        <div className="bg-surface dark:bg-slate-800 dark:bg-surface p-6 flex items-center justify-between">
          ...
          <button
            ...
            onClick={clearAll}
            className="px-4 py-2 bg-rose-50 border border-rose-200 text-rose-600 dark:text-rose-400 rounded-lg text-xs font-bold hover:bg-rose-600 hover:text-white transition flex items-center gap-2"
          >
