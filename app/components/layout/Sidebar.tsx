  ...
  return (
    <aside className="w-64 bg-[#0F111A] border-r border-white/5 flex flex-col h-full z-40 hidden md:flex flex-shrink-0">
      ...
      <div className="flex-1 py-6 px-3 space-y-1 overflow-y-auto">
        <div className="text-xs font-bold text-gray-300 dark:text-gray-300 uppercase tracking-wider mb-4 px-3">
          Platform
        </div>
      ...
      <div className="p-4 border-t border-white/5">
        <button className="flex items-center gap-3 w-full p-2 rounded-xl hover:bg-white/5 transition-colors group">
           ...
           <div className="text-left overflow-hidden">
             ...
             <div className="text-xs text-gray-300 dark:text-gray-300 truncate">Free Plan</div>
           </div>
           <Settings size={14} className="ml-auto text-gray-300 dark:text-gray-300 group-hover:text-white transition-colors" />
        </button>
      </div>
    </aside>
  );
