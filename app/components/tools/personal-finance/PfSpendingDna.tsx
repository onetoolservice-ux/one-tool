...
const ARCHETYPES = [
  {
    id: 'experiences',
    name: 'The Experience Spender',
    emoji: '✈️',
    description: 'Travel and dining eat a large share of your income. These are real expenses — enjoyable, but they compound fast and leave little room for savings.',
    traits: ['High travel/dining spend', 'Low savings buffer', 'Vulnerable to income shocks'],
    color: '#f97316',
  ...
  {
    id: 'homebody',
    name: 'The Housing-Heavy Spender',
    emoji: '🏠',
    description: 'Housing costs are eating more than 30% of your income. That leaves less room for investments and emergencies than most financial guidelines recommend.',
    traits: ['High fixed housing costs', 'Limited financial flexibility', 'Low discretionary room'],
    color: '#10b981',
  ...
  },
  {
    ...
    emoji: '🛍️',
    description: 'Shopping is taking more than 25% of your spend. That is a pattern, not a one-off. Without a spending limit, retail therapy becomes an expensive habit.',
    traits: ['High discretionary shopping spend', 'Reactive buying patterns', 'Low savings discipline'],
    color: '#ec4899',
  ...
  },
  {
    ...
    emoji: '📈',
    description: 'You are putting more than 20% into investments. That is genuinely uncommon and puts you ahead of most. Keep the lifestyle inflation in check.',
    traits: ['High investment allocation', 'Future-focused', 'Disciplined spending'],
    color: '#6366f1',
    conditions: (cats: Record<string, number>) => (cats['Investment'] || 0) > 20,
  },
  {
    id: 'foodie',
    name: 'The Food Overspender',
    emoji: '🍽️',
    description: 'Food and dining together exceed 30% of your expenses. Groceries are necessary — but restaurant spend in this range is a controllable habit worth reviewing.',
    traits: ['High food & dining spend', 'Frequent small transactions', 'Easy quick wins available'],
    color: '#f59e0b',
  ...
  },
  {
    ...
    emoji: '⚖️',
    description: 'Your spending is distributed across categories without a single dominant leak. This is a stable pattern — the next step is building a real savings rate, not just avoiding overspend.',
    traits: ['Distributed spending', 'No single category dominates', 'Room to improve savings rate'],
    color: '#14b8a6',
