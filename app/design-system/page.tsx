        ...
        <div className="space-y-6">
          ...
          <div className="p-5 bg-surface dark:bg-slate-800 dark:bg-surface border border-line dark:border-slate-700 dark:border-slate-800 rounded-lg space-y-4">
            <div className="flex flex-wrap gap-3 items-center">
              ...
              <button
                className="px-4 py-2 bg-surface dark:bg-slate-800 border border-line dark:border-slate-700 text-muted dark:text-muted/70 hover:bg-background rounded-md text-sm font-bold"
              >
                Secondary
              </button>
              <button
                aria-label="Delete Item"
                className="p-2 text-muted/70 hover:text-rose-500 hover:bg-rose-50 rounded-md"
              >
                <Trash2 size={16} />
              </button>
            </div>
