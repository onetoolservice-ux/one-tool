...
// We are boosting the opacity from /10 to /20 and /30 to make the colors visible
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/30 dark:bg-[#0B1120] relative overflow-hidden">
      ...
      {/* í¾¨ VIBRANT ENTERPRISE AURORA BACKGROUND */}
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden -z-50 pointer-events-none">
        {/* Top Right: The Green Shadow (Boosted Opacity) */}
        <div className="absolute top-[-10%] -right-[10%] w-[60vw] h-[60vw] bg-emerald-500/20 dark:bg-emerald-500/15 rounded-full blur-[100px]" />
        
        {/* Top Left: Indigo Glow */}
        <div className="absolute -top-[20%] -left-[10%] w-[70vw] h-[70vw] bg-indigo-500/15 dark:bg-indigo-500/15 rounded-full blur-[120px] animate-pulse delay-700" />
...
console.log("âœ… Restored visuals. Green Shadow (Aurora) is back!");
